      ...
      <el-dialog title="添加成员" :visible.sync="dialogVisible" width="500px">
        <el-form class="" label-width="120px">
          <el-form-item label="用户名/姓名:">
            <el-select class="full-input-w" v-model="addUserForm.userIds" multiple filterable remote reserve-keyword placeholder="请输入用户名/姓名搜索" :remote-method="remoteMethod" :loading="addUserloading">
