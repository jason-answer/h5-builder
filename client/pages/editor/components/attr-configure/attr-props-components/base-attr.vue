    ...
    <el-collapse v-model="activeNames">
      <el-collapse-item title="尺寸与位置：" name="1">
        ...
        <div class="attr-item-edit-wrapper">
          ...
          <div class="col-2 attr-item-edit-input">
            <el-input-number v-model="activeElement.commonStyle.width" size="mini" controls-position="right" :min="0" />
            <div class="attr-item-edit-input-des">
              宽度
            </div>
          </div>
          <div class="col-2 attr-item-edit-input">
            <el-input-number v-model="activeElement.commonStyle.height" size="mini" controls-position="right" :min="0" />
            <div class="attr-item-edit-input-des">
              高度
            </div>
          </div>
        ...
        <div class="attr-item-edit-wrapper">
          ...
          <div class="col-2 attr-item-edit-input">
            <el-input-number v-model="activeElement.commonStyle.top" size="mini" controls-position="right" />
            <div class="attr-item-edit-input-des">
              X
            </div>
          </div>
          <div class="col-2 attr-item-edit-input">
            <el-input-number v-model="activeElement.commonStyle.left" size="mini" controls-position="right" />
            <div class="attr-item-edit-input-des">
              Y
            </div>
          </div>
        ...
        <div class="attr-item-edit-wrapper">
          ...
          <div class="col-1 attr-item-edit-input">
            <el-slider v-model="activeElement.commonStyle.rotate" show-input :min="-180" :max="180" :marks="{0:'',90:'', '-90':''}" input-size="mini" @change="throttleAddHistory" />
          </div>
        </div>
      </el-collapse-item>
      ...
      <el-collapse-item title="边框边距：" name="2">
        ...
        <div class="attr-item-edit-wrapper">
          ...
          <div class="col-2 attr-item-edit-input">
            <el-input-number v-model="activeElement.commonStyle.borderWidth" size="mini" controls-position="right" :min="0" @change="throttleAddHistory" />
            <div class="attr-item-edit-input-des">
              尺寸
            </div>
          </div>
          <div class="col-3 attr-item-edit-input">
            <el-color-picker v-model="activeElement.commonStyle.borderColor" size="mini" @change="throttleAddHistory" />
            <div class="attr-item-edit-input-des">
              颜色
            </div>
          </div>
          <div class="col-2 attr-item-edit-input">
            <el-select v-model="activeElement.commonStyle.borderStyle" size="mini" @change="throttleAddHistory">
        ...
        <div class="attr-item-edit-wrapper">
          ...
          <div class="col-2 attr-item-edit-input">
            <el-input-number v-model="activeElement.commonStyle.borderRadius" size="mini" controls-position="right" :min="0" @change="throttleAddHistory" />
          </div>
        </div>
        <!--边距-->
        ...
        <div class="attr-item-edit-wrapper">
          ...
          <div class="col-2 attr-item-edit-input">
            <el-input-number v-model="activeElement.commonStyle.paddingTop" size="mini" controls-position="right" :min="0" @change="throttleAddHistory" />
          </div>
          <div class="col-2 attr-item-edit-input">
            <el-input-number v-model="activeElement.commonStyle.paddingBottom" size="mini" controls-position="right" :min="0" @change="throttleAddHistory" />
          </div>
        </div>
        <div class="attr-item-edit-wrapper">
          <p class="attr-item-title">
          ...
          <div class="col-2 attr-item-edit-input">
            <el-input-number v-model="activeElement.commonStyle.paddingLeft" size="mini" controls-position="right" :min="0" @change="throttleAddHistory" />
          </div>
          <div class="col-2 attr-item-edit-input">
            <el-input-number v-model="activeElement.commonStyle.paddingRight" size="mini" controls-position="right" :min="0" @change="throttleAddHistory" />
          </div>
        </div>
        <!--外边距-->
      </el-collapse-item>
      <el-collapse-item title="阴影样式：" name="3">
        ...
        <div class="attr-item-edit-wrapper">
          ...
          <div class="col-2 attr-item-edit-input">
            <el-input-number v-model="boxShadow.spread" size="mini" controls-position="right" @change="boxShadowChange" />
            <div class="attr-item-edit-input-des">
              垂直阴影位置
            </div>
          </div>
      ...
      <el-collapse-item title="字体：" name="4">
        <div class="attr-item-edit-wrapper">
          ...
          <div class="col-2 attr-item-edit-input">
            <el-input-number v-model="activeElement.commonStyle.fontSize" size="mini" controls-position="right" :min="0" @change="throttleAddHistory" />
          </div>
        </div>
        <div class="attr-item-edit-wrapper">
          <p class="attr-item-title">
          ...
          <div class="col-2 attr-item-edit-input">
            <el-input-number v-model="activeElement.commonStyle.fontWeight" size="mini" controls-position="right" :min="300" :step="100" :max="900" @change="throttleAddHistory" />
          </div>
        </div>
        <div class="attr-item-edit-wrapper">
          <p class="attr-item-title">
          ...
          <div class="col-2 attr-item-edit-input">
            <el-input-number v-model="activeElement.commonStyle.lineHeight" size="mini" controls-position="right" :min="0" :step="0.1" @change="throttleAddHistory" />
          </div>
        </div>
        <div class="attr-item-edit-wrapper">
          <p class="attr-item-title">
          ...
          <div class="col-2 attr-item-edit-input">
            <el-input-number v-model="activeElement.commonStyle.letterSpacing" size="mini" controls-position="right" :min="0" @change="throttleAddHistory" />
          </div>
        </div>
        <div class="attr-item-edit-wrapper">
          <p class="attr-item-title">
        ...
        <div class="attr-item-edit-wrapper">
          ...
          <div class="attr-item-edit-input">
            <el-color-picker v-model="activeElement.commonStyle.color" size="mini" @change="throttleAddHistory" />
          </div>
        </div>
      </el-collapse-item>
      <el-collapse-item title="背景&&透明度：" name="5">
        <div class="attr-item-edit-wrapper">
          ...
          <div class="attr-item-edit-input no-top">
            <el-color-picker v-model="activeElement.commonStyle.backgroundColor" size="mini" :show-alpha="true" @change="throttleAddHistory" />
          </div>
        </div>
        <div class="attr-item-edit-wrapper">
          <p class="attr-item-title">
        ...
        <div class="attr-item-edit-wrapper">
          ...
          <div class="col-2 attr-item-edit-input">
            <el-input-number v-model="activeElement.commonStyle.opacity" size="mini" controls-position="right" :min="0" :max="1" :step="0.1" @change="throttleAddHistory" />
          </div>
        </div>
      </el-collapse-item>
    </el-collapse>
